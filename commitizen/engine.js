...
var defaults = require('@digitalroute/cz-conventional-changelog-for-jira/defaults');
const LimitedInputPrompt = require('@digitalroute/cz-conventional-changelog-for-jira/LimitedInputPrompt');
      ...
      cz.prompt([
        ...
        },
        {
          ...
          leadingLabel: answers => {
            ...
            return `${jira} - ${answers.type}${scope}:`;
          },
          validate: input =>
        ...
        const head = jira + answers.type + scope + ': ' + answers.subject;
